...
4. Tambem foi incluido dentro do docker-compose uma imagem do pgadmin, assim podendo averiguar o armazenamento de dados na tabela em tempo real, o link para o acesso é (http://localhost:15440/), na pagina de login use o Email: teste@gmail.com e a Senha: pgadmin.
